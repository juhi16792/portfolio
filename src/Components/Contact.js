...
const Contact = ({ data }) => {
   // const [url, setUrl] = useState('mailto:lrjuheeshwari16@gmail.com?subject=subject&body=body');
           ...
           <div id="message-warning"> Error boy</div>
            ...
            <aside className="four columns footer-widgets">
               <div className="widget widget_contact">
					   ...
					   <h4><a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=lrjuheeshwari16@gmail.com" target="_blank">  Contact Me </a></h4>
					   <p className="address">
                     <br/>			  
